...
1. [Hai dự án bên trong](#1-hai-dự-án-bên-trong)
2. [Kiến trúc & phân vùng domain](#2-kiến-trúc--phân-vùng-domain)
3. [Yêu cầu hệ thống](#3-yêu-cầu-hệ-thống)
4. [Bắt đầu nhanh](#4-bắt-đầu-nhanh)
5. [Chạy từng dự án](#5-chạy-từng-dự-án)
